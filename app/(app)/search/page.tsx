...
const SECTIONS = [
  ...
  { label: 'Historical Books', testament: 'OT', books: ['Joshua','Judges','Ruth','1 Samuel','2 Samuel','1 Kings','2 Kings','1 Chronicles','2 Chronicles','Ezra','Nehemiah','Esther'] },
  { label: 'Wisdom & Poetry',  testament: 'OT', books: ['Job','Psalms','Proverbs','Ecclesiastes','Song of Songs'] },
  { label: 'Major Prophets',   testament: 'OT', books: ['Isaiah','Jeremiah','Lamentations','Ezekiel','Daniel'] },
  ...
  { label: 'Acts',             testament: 'NT', books: ['Acts'] },
  { label: 'Epistles',         testament: 'NT', books: ['Romans','1 Corinthians','2 Corinthians','Galatians','Ephesians','Philippians','Colossians','1 Thessalonians','2 Thessalonians','1 Timothy','2 Timothy','Titus','Philemon','Hebrews','James','1 Peter','2 Peter','1 John','2 John','3 John','Jude'] },
  { label: 'Prophecy',         testament: 'NT', books: ['Revelation'] },
]

const FEATURED_THEMES = [
  'sin','covenant','sovereignty','faith','community','hope',
  'calling','prayer','suffering','obedience','grace','worship',
  'leadership','stewardship','identity','pride','love',
  'repentance','wisdom','justice','holiness',
]
